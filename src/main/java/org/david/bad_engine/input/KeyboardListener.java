...
/**
 * Listens to user's keyboard input.
 *
 * @author Mr. GodDavid
 * @since 3/31/2026
 */
...
public final class KeyboardListener implements KeyListener {
    ...
    /**
     * Fires a key event <strong>ONLY ONE TIME</strong> in game loop. If the player presses down a key, the key event
    ...
    /**
     * Fires a key event <strong>MULTIPLE TIMES</strong> in game loop. If the player types a key (presses down and
